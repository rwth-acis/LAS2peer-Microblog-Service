      ...
      return this.module("microblog", function() {
        ...
        return this.ElementGenerator = (function() {
          ...
          ElementGenerator.generateEntryElements = function(xmlInnerArr, clickevent, parent) {
            var author, div, i, k, text, time, _i, _len, _results;
            _results = [];
            for (i = _i = 0, _len = xmlInnerArr.length; _i < _len; i = ++_i) {
              k = xmlInnerArr[i];
              ...
              $(div).click(function(event) {
                if (clickevent != null) {
                  return clickevent(event.target.id);
                }
              });
              _results.push($(parent).append(div));
            }
            return _results;
          };
          ...
          ElementGenerator.generateMultilineTextfield = function(parent) {
            ...
            return $(parent).append(textfieldDiv);
          };
